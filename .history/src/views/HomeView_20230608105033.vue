...
export default {
  ...
  methods: {
    ...
    setChartOptions1() {
      ...
      const surfaceBorder = documentStyle.getPropertyValue("--gray-700");
...
<template>
  <div class="flex min-h-screen max-w-full bg-gray-800">
    <div class="conteudo w-full p-3">
      <div class="mt-3 mb-5 text-center">
        <h1 class="titulo md:text-6xl">Dashboard Financeiro</h1>
      </div>

      <Divider class="mb-6"/>

      <div
        class="m-4 flex flex-row flex-wrap align-items-center justify-content-center md:justify-content-between"
      >
        <div class="card md:w-6 w-12 my-4 md:my-auto">
          <Chart
            type="line"
            :data="chartData1"
        ...
        <div class="card md:w-3 w-12 my-4 md:my-auto">
          <Chart
            type="line"
            :data="chartData2"
        ...
        <h2 class="md:text-5xl text-3xl titulo my-4 md:my-auto text-center">
          =
        ...
        <div class="card flex justify-content-center">
          <Chart
            ...
            class="max-w-15rem h-13rem my-4 md:my-auto"
          />
        </div>
        ...
        <div class="card flex justify-content-center my-4 md:my-auto">
          <Chart
            type="pie"
            :data="chartData5"
