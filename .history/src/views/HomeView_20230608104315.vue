...
<template>
  <div class="flex min-h-screen min-w-screen bg-gray-800">
    <div class="conteudo w-full m-3">
      ...
      <div
        class="m-4 flex flex-row flex-wrap align-items-center justify-content-center lg:justify-content-between"
      >
        <div class="card my-4 lg:my-auto">
          <Chart
            type="line"
            :data="chartData1"
        ...
        <h2 class="text-5xl titulo my-4 lg:my-auto">
          =
        ...
        <div class="card flex justify-content-center">
          <Chart
            ...
            class="max-w-15rem h-13rem my-4 lg:my-auto"
          />
        </div>

        <div class="card lg:w-6 w-12 my-4 lg:my-auto">
          <Chart
            type="bar"
            :data="chartData4"
        ...
        <div class="card flex justify-content-center my-4 lg:my-auto">
          <Chart
            type="pie"
            :data="chartData5"
